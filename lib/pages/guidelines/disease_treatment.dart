...
class _DiseaseTreatmentState extends State<DiseaseTreatment> {
  ...
  Widget build(BuildContext context) {
    return Pager('Disease Treatment Guidelines', [
      Widgets.header('Bone and Joints'),
      Column(
        children: [
          Card(
            child: ListTile(
              title: Widgets.text('Infective Arthritis', weight: FontWeight.w600),
      ...
      Column(
        children: [
          ...
          Card(
            child: ListTile(
              title: Widgets.text('Otitis Media (Acute)', weight: FontWeight.w600),
              trailing: Icon( Icons.arrow_forward_ios, size: 20, ),
              onTap: (){
                Navigator.push(context, MaterialPageRoute(
                  builder: (BuildContext context) => SingleDisease()));
              },
            ),
          ),
        ],
