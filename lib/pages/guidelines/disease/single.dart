...
class _SingleDiseaseState extends State<SingleDisease> {
  ...
  Widget build(BuildContext context) {
    return Pager('Otitis Media (Acute)', [
        Widgets.collapsible( 'Overview', [
          Widgets.text('A disorder of the ear, tympanic membrane, common in tropics')
        ]),
        ...
        Card(
          child: ListTile(
            title: Widgets.text('Drug Management', size: 17, weight: FontWeight.w600),
